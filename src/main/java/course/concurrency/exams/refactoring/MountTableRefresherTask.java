...
public class MountTableRefresherTask implements Supplier<MountTableRefreshResult> {
     ...
     */
    @Override
    public MountTableRefreshResult get() {
        return new MountTableRefreshResult(manager.refresh(), adminAddress);
    }
}
